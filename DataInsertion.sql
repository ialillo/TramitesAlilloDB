...
INSERT INTO Catalogos.ConceptoCarga(nombreConceptoCarga) SELECT 'ABARROTESALIMENTOS VARIOS'
INSERT INTO Catalogos.ConceptoCarga(nombreConceptoCarga) SELECT 'ANUNCIOS Y LO RELAC.'
INSERT INTO Catalogos.ConceptoCarga(nombreConceptoCarga) SELECT 'ARTICULOS DEPORTIVOS'
INSERT INTO Catalogos.ConceptoCarga(nombreConceptoCarga) SELECT 'ARTICULOS PARA EL HOGAR'
INSERT INTO Catalogos.ConceptoCarga(nombreConceptoCarga) SELECT 'AVICULTURA Y LO RELAC.'
INSERT INTO Catalogos.ConceptoCarga(nombreConceptoCarga) SELECT 'BANQUETES'
INSERT INTO Catalogos.ConceptoCarga(nombreConceptoCarga) SELECT 'BEBIDAS ALCOHOLICAS'
INSERT INTO Catalogos.ConceptoCarga(nombreConceptoCarga) SELECT 'BEBIDAS EMBOTELLADAS'
INSERT INTO Catalogos.ConceptoCarga(nombreConceptoCarga) SELECT 'CARNES Y EMBUTIDOS'
INSERT INTO Catalogos.ConceptoCarga(nombreConceptoCarga) SELECT 'CARROZA Y LO REL. FUNERARIA'
INSERT INTO Catalogos.ConceptoCarga(nombreConceptoCarga) SELECT 'CORROSIVOS'
INSERT INTO Catalogos.ConceptoCarga(nombreConceptoCarga) SELECT 'DESPERDICIOS INDUSTRIALES NO PELIGROSOS'
INSERT INTO Catalogos.ConceptoCarga(nombreConceptoCarga) SELECT 'EXPLOSIVOS'
INSERT INTO Catalogos.ConceptoCarga(nombreConceptoCarga) SELECT 'FERRETERIA, PLOMERIA,TLAPALERIA'
INSERT INTO Catalogos.ConceptoCarga(nombreConceptoCarga) SELECT 'FLORESFUNERARIOS'
INSERT INTO Catalogos.ConceptoCarga(nombreConceptoCarga) SELECT 'GANADO EN GENERAL'
INSERT INTO Catalogos.ConceptoCarga(nombreConceptoCarga) SELECT 'GASES COMPRIMIDOS REFRIGERADOS LICUADOS O DISUELTOS'
INSERT INTO Catalogos.ConceptoCarga(nombreConceptoCarga) SELECT 'HERRERIAHIELOJALA REMOLQUE'
INSERT INTO Catalogos.ConceptoCarga(nombreConceptoCarga) SELECT 'JARDINERIA Y SIMILAR'
INSERT INTO Catalogos.ConceptoCarga(nombreConceptoCarga) SELECT 'JUGUETES'
INSERT INTO Catalogos.ConceptoCarga(nombreConceptoCarga) SELECT 'LACTEOS Y LO RELAC.'
INSERT INTO Catalogos.ConceptoCarga(nombreConceptoCarga) SELECT 'LAVANDERIA Y TINTORERIA'
INSERT INTO Catalogos.ConceptoCarga(nombreConceptoCarga) SELECT 'LITOGRAFIA Y PAPELERIA'
INSERT INTO Catalogos.ConceptoCarga(nombreConceptoCarga) SELECT 'LO REL. A LA EMPRESA'
INSERT INTO Catalogos.ConceptoCarga(nombreConceptoCarga) SELECT 'MAQUINARIA Y EQUIPO EN GENERAL'
INSERT INTO Catalogos.ConceptoCarga(nombreConceptoCarga) SELECT 'MATERIAL ELECTRICO'
INSERT INTO Catalogos.ConceptoCarga(nombreConceptoCarga) SELECT 'MATERIALES DE CONSTRUCCION'
INSERT INTO Catalogos.ConceptoCarga(nombreConceptoCarga) SELECT 'MENSAJERIA Y PAQUETERIA'
INSERT INTO Catalogos.ConceptoCarga(nombreConceptoCarga) SELECT 'METALES'
INSERT INTO Catalogos.ConceptoCarga(nombreConceptoCarga) SELECT 'MUEBLES EN GENERAL'
INSERT INTO Catalogos.ConceptoCarga(nombreConceptoCarga) SELECT 'NUPCIAL'
INSERT INTO Catalogos.ConceptoCarga(nombreConceptoCarga) SELECT 'OXIDANTES Y PEROXIDOS ORGANICOS'
INSERT INTO Catalogos.ConceptoCarga(nombreConceptoCarga) SELECT 'PAN Y SIMILARESPAPEL INDUSTRIALPAPELERIA'
INSERT INTO Catalogos.ConceptoCarga(nombreConceptoCarga) SELECT 'PAPELERIA EN GENERAL'
INSERT INTO Catalogos.ConceptoCarga(nombreConceptoCarga) SELECT 'PARTES AUTOMOTRICES Y REFACCIONES EN GRAL.'
INSERT INTO Catalogos.ConceptoCarga(nombreConceptoCarga) SELECT 'PARTICULARPIPA'
INSERT INTO Catalogos.ConceptoCarga(nombreConceptoCarga) SELECT 'PROD. AGRICOLAS Y LO REL. CAMPO'
INSERT INTO Catalogos.ConceptoCarga(nombreConceptoCarga) SELECT 'PRODUCTOS FORESTALES'
INSERT INTO Catalogos.ConceptoCarga(nombreConceptoCarga) SELECT 'PRODUCTOS MINERALES NO METALURGICOS'
INSERT INTO Catalogos.ConceptoCarga(nombreConceptoCarga) SELECT 'PRODUCTOS QUIMICOS'
INSERT INTO Catalogos.ConceptoCarga(nombreConceptoCarga) SELECT 'PRODUCTOS QUIMICOS NO PELIGROSOS'
INSERT INTO Catalogos.ConceptoCarga(nombreConceptoCarga) SELECT 'RELACIONADO CON LA MINERIA'
INSERT INTO Catalogos.ConceptoCarga(nombreConceptoCarga) SELECT 'TEXTILES'
INSERT INTO Catalogos.ConceptoCarga(nombreConceptoCarga) SELECT 'TRANSPORTE DE MOTOCICLETAS'
INSERT INTO Catalogos.ConceptoCarga(nombreConceptoCarga) SELECT 'USO DE CASA HABITACION'
INSERT INTO Catalogos.ConceptoCarga(nombreConceptoCarga) SELECT 'VIDRIERIA'